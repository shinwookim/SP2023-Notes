...
This puts the thread in the block state 
...
This is great since it does not require any kernel support; this is likely faster than kernel threads but is harder to do non-blocking I/O. 
